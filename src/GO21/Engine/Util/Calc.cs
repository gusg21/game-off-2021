...
namespace GO21Engine.Util
{
    public static class Calc
    {
        ...
        public static Vector2 Toward(Actor from, Actor to, float length)
        {
        ...
        public static int SortLeftToRight(Actor a, Actor b)
        {
            return (int)((a.X - b.X) * 100);
        }

        public static int SortRightToLeft(Actor a, Actor b)
        {
            return (int)((b.X - a.X) * 100);
        }

        public static int SortTopToBottom(Actor a, Actor b)
        {
            return (int)((a.Y - b.Y) * 100);
        }

        public static int SortBottomToTop(Actor a, Actor b)
        {
            return (int)((b.Y - a.Y) * 100);
        }

        public static int SortByDepth(Actor a, Actor b)
        {
            return a.Depth - b.Depth;
        }

        public static int SortByDepthReversed(Actor a, Actor b)
        {
